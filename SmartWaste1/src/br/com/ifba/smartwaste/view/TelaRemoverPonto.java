 ...
 * @author pc
 */
public class TelaRemoverPonto extends javax.swing.JDialog {

    /**
     * Creates new form TelaCadastroPonto
     */
    public TelaRemoverPonto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Remover ponto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRemoverPonto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaRemoverPonto dialog = new TelaRemoverPonto(new javax.swing.JFrame(), true);
